...
module.exports = {
  "content": [
      ...
      [
        ...
        [
          ...
          [
            ...
            {
              "title": null,
              "href": "https://ant.design/docs/react/getting-started#Compatibility"
            },
            "polyfills"
          ],
          ")"
    ...
    [
      ...
      " tags in your browser and use the global variable ",
      [
        "code",
        "antd"
      ],
    ...
    [
      ...
      " in antd's npm package. You can also download these files directly from ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      [
        ...
        " this will add bloat to your application and make it more difficult to receive bugfixes and updates. Antd is intended to be used in conjunction with a build tool, such as ",
        [
          "a",
          {
            "title": null,
        ...
        ", which will make it easy to import only the parts of antd that you are using."
      ],
      [
        "p",
        "Note: you should import moment before using antd.js after ",
        [
          "code",
          "3.0"
        ],
    ...
    [
      ...
      [
        ...
        [
          ...
          {
            "lang": "jsx",
            "highlighted": "<span class=\"token keyword\">import</span> DatePicker <span class=\"token keyword\">from</span> <span class=\"token string\">'antd/lib/date-picker'</span><span class=\"token punctuation\">;</span>  <span class=\"token comment\" spellcheck=\"true\">// for js</span>\n<span class=\"token keyword\">import</span> <span class=\"token string\">'antd/lib/date-picker/style/css'</span><span class=\"token punctuation\">;</span>        <span class=\"token comment\" spellcheck=\"true\">// for css</span>\n<span class=\"token comment\" spellcheck=\"true\">// import 'antd/lib/date-picker/style';         // that will import less</span>"
          },
          [
            "code",
      ...
      [
        ...
        [
          ...
          [
            ...
            {
              "title": null,
              "href": "http://www.antfin.com/index.htm?locale=en_US"
            },
            "Ant Financial"
          ]
        ]
    ...
    [
      ...
      [
        "p",
        "If your company or product uses Ant Design, let us know ",
        [
          "a",
          {
            "title": null,
    ...
    [
      "p",
      "If you'd like to help us improve antd, just create a ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      [
        "p",
        "If you're new to posting issues, we ask that you read ",
        [
          "a",
          {
            "title": null,
        ...
        " prior to posting. Well written bug reports help us help you!"
      ]
    ],
    [
      "h2",
    ...
    [
      "p",
      "For questions on how to use antd, please post questions to ",
      [
        "a",
        {
          "title": null,
      ...
      " tag. If you're not finding what you need on stackoverflow, you can find us on ",
      [
        "a",
        {
          "title": null,
  ...
  "meta": {
    ...
    "filename": "docs/advanced/introduce.en-US.md"
  },
  "description": [
    "section",
    [
      "p",
      "Following the Ant Design specification, we developed a React UI library ",
      [
        "code",
        "antd"
      ],
  ...
  "toc": [
    ...
    [
      ...
      [
        ...
        {
          "className": "bisheng-toc-h2",
          "href": "#Companies-using-antd",
          "title": "Companies using antd"
        },
        "Companies using antd"
      ]
    ],
...
//# sourceMappingURL=introduce.en-US.md.js.map